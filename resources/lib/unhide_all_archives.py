...
addon = xbmcaddon.Addon(id='plugin.program.iarlnes')
current_setting = addon.getSetting('iarlnes_setting_clear_hidden_archives')
...
if 'false'.lower() in current_setting.lower():
	...
	if ret1 == 0:
		...
		addon.setSetting(id='iarlnes_setting_clear_hidden_archives',value='true')
