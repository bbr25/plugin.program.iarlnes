...
addon = xbmcaddon.Addon(id='plugin.program.iarlsnes')
current_setting = addon.getSetting('iarlsnes_setting_clear_hidden_archives')
...
if 'false'.lower() in current_setting.lower():
	...
	if ret1 == 0:
		...
		addon.setSetting(id='iarlsnes_setting_clear_hidden_archives',value='true')
